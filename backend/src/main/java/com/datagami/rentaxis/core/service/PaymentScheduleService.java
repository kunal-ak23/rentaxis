...
public class PaymentScheduleService {
    ...
    // extendScheduleForLease is gone with LeaseService.extendLease, its only
    // caller. An extension is a posting now (spec §6.7): LeaseRenewalService.extend
    // appends RENT lines for the new window, posts a further TCO for them and
    // registers the cheques that pay for it. Continuing a payment schedule the
    // ledger knows nothing about would have billed the extension twice.
