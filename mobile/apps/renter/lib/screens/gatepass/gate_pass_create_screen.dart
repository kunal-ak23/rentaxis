...
class _L {
  ...
  String get worksStraightAway => ar ? 'يعمل فورًا' : 'Works straight away';
  ...
  String get chooseUnit => ar
      ? 'اختر الوحدة التي سيكون هذا التصريح لها.'
      : 'Choose which unit this pass is for.';
  ...
  String get createFailed => ar
      ? 'تعذر إنشاء التصريح. حاول مرة أخرى.'
      : 'Could not create the pass. Please try again.';
  String get noActiveTenancy =>
      ar ? 'لا يوجد عقد إيجار نشط' : 'No active tenancy';
