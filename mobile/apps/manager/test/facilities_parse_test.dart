...
void main() {
  ...
  // `errorMessage`'s own tests moved to
  // rentaxis_core/test/utils/error_message_test.dart — the owning package
  // tests its own util directly rather than through this app's usage of it.
  // facilities_utils.dart re-exports the symbol, so callers here (and this
  // file's other groups) are unaffected.
