...
- Current mobile baseline on `origin/main` `42c398f`: 512/512 Flutter unit/widget tests pass (core 94, manager 100, renter 224, security 94); Manager, Renter, and Security analyzers report no issues. Shared core has no analyzer errors and one existing unused-import warning plus 52 information-level style diagnostics.
