...
| 02. Dashboard, search, notifications, and help | Web, Manager, Renter | All | KPI dashboard, global search, alerts, notification center, help articles, guided tours | Prod E2E (notification delivery); production browser journeys prepared for exact notification inbox/unread/read state, KPI dashboard, command-palette lease navigation, Security Guard help detail, and Super Admin follow-ups; #100–#102 and #108 are deployed; exact-current production rerun remains pending; Local E2E |
...
- Exact-current mobile baseline: 546/546 Flutter unit/widget tests pass across deployed main `0aba0c3` (core 123, Manager 105, Renter 224, Security 94). All four analyzers are clean; merged #114 supplies the shared-core Dart 3.10 lint cleanup without changing request semantics.
...
- Audio/video toolchain: [render-tutorial.sh](./render-tutorial.sh) accepts Azure MAI-Voice, OpenAI TTS, reviewed external Gemini/Kokoro narration, or draft-only macOS speech; rejects empty audio; holds the last visual frame when necessary; normalizes to -16 LUFS; renders a 1080p H.264/AAC MP4; and verifies codecs, streams, dimensions, and output duration before replacing an existing tutorial.
