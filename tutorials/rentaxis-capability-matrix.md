...
| 13. Renew, extend, terminate, and settle a lease | Web, Manager, Renter | Super admin, tenant admin, property manager, renter | Renewal opportunities, reminders, renter intent, extension, termination, deductions, settlement preview/finalization | Production browser journey prepared for renter renewal banner/reminders/intent/captured/post-close states with tenant-scoped scan and admin close assertions; extension/settlement API lifecycle prepared; production run pending safety deployments; manager widget coverage |
