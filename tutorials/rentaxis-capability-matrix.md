...
- Current `origin/main` baseline `c8ac199` includes #95, #98–#101, #104–#107, and the tutorial assets from #106. GitHub Actions deployment run 32764624958 completed successfully for that exact commit. The remaining open work is production E2E coverage #96, search #102, notification inbox #108, Manager route tests #110, and public registration #111, plus this route-map verifier.
