...
| 2026-09-03 | Property Manager shell | The property-manager capture also displayed the generic `Organization` footer instead of the active tutorial tenant name. | Reproduced in Tutorial 03 fresh-tenant capture; needs a focused UI fix. |
