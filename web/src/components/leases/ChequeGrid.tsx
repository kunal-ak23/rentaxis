...
type Props = {
    ...
    /** The server's own Σ, when a dry run has been made. Falls back to the rows. */
    chequeTotal?: number | null;
...
export default function ChequeGrid({
    ...
    const rowsTotal = cheques.reduce((s, c) => round2(s + (c.amount || 0)), 0);
    const total = chequeTotal ?? rowsTotal;
