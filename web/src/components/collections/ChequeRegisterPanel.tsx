...
/**
 * The cheque register (Cheque / Cash Collection › Cheque register). Embedded
 * in the hub it renders an h2 and drops the cross-links to the other cheque
 * views, which are the hub's own pills there. `?receive=1` opens the cash
 * receipt straight away (the contract's "Record payment" lands here).
 */
export default function ChequeRegisterPanel({ embedded = false }: { embedded?: boolean }) {
