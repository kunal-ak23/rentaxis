 ...
 */
export default function PenaltiesPanel({ embedded = false, propertyId }: { embedded?: boolean; propertyId?: string }) {
    ...
    return (
        <div>
            ...
            <PenaltyQueue userRole={userRole} propertyId={propertyId || undefined} />
        </div>
    );
}
