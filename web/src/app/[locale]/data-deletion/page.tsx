  ...
  return (
    <main className="min-h-screen bg-[#0d0d0d] px-6 py-16 text-[#f7f2e8]">
      <article className="mx-auto max-w-3xl">
        ...
        <h1 className="font-serif text-4xl font-semibold md:text-5xl">Account and data deletion</h1>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-[#f1c84c]">How to submit a request</h2>
        ...
        <section className="mt-10">
          <h2 className="text-2xl font-semibold text-[#f1c84c]">What happens next</h2>
