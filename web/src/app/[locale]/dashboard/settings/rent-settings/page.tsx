        ...
        return (
            <div className="max-w-4xl">
                <div className="bg-white rounded-2xl p-12 shadow-sm border border-gray-100 text-center">
                    ...
                    <p className="text-sm text-gray-500">You do not have permission to configure rent settings.</p>
                </div>
            </div>
        );
    }
            ...
            {settings && !loading && (
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Penalty Type */}
                        <div>
                            <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-1.5">
