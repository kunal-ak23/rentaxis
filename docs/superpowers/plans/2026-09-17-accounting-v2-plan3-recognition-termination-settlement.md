...
- [ ] **Step 1: Failing IT** (Sample Residences fixture: RENT 51,000 24-09-2026→23-09-2027 + ADMIN 2,000; post via `LeasePostingService`):
...
- [ ] **Step 1: Failing IT** (Anil's scenario, Sample Residences fixture posted 16-09-2026, cheques 2,000 admin 11-09 + 4 × 12,750 (02-10-2026, 02-01-2027, 02-04-2027, 02-07-2027); clear admin + first two rent cheques; recognise through 2027-01-31):
