...
## 1. Overview
The Multi-Tenant SaaS Foundation is the core architectural pillar of RentAxis. It ensures that a single deployed instance of the application can securely serve multiple Landlord Organizations (Tenants) while maintaining strict data isolation. 
...
- `PUT /api/v1/settings` (Tenant Admin: Update Currency, Reminders, Defaults)
...
- **Landlord Portal (Settings):** Interface for Landlord Admins to configure global settings such as currency, overdue grace periods, and template customizations.
...
- Create Super Admin tooling to explicitly create Landlord Organizations.
